...
<figure class="wp-block-image size-full"><img src="/wp-content/plugins/pitea-customisation/static/images/dummies/dummy-image.jpg" alt="Dummy image" class="wp-image-471"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-large"><img src="/wp-content/plugins/pitea-customisation/static/images/dummies/dummy-image-inverted.jpg" alt="Dummybild"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","width":"45%","className":"has-custom-width"} -->
<div class="wp-block-column is-vertically-aligned-center has-custom-width" style="flex-basis:45%"><!-- wp:image {"id":471,"sizeSlug":"full","linkDestination":"none"} -->
